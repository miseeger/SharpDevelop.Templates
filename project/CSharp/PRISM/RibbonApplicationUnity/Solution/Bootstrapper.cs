...
namespace ${SolutionName}
{
	...
	public class Bootstrapper : UnityBootstrapper
	{
		...
		protected override RegionAdapterMappings ConfigureRegionAdapterMappings()
		{
	        ...
	        if (mappings != null)
	        {
	            mappings.RegisterMapping(typeof(Ribbon), this.Container.Resolve<RibbonTabRegionAdapter>());
	            mappings.RegisterMapping(typeof(BackstageTabControl), this.Container.Resolve<RibbonBackstageRegionAdapter>());
	        }			
	        else
	        {
	        	return null;
