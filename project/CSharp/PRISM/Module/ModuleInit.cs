...
// TODO: Insert references to the Projects 
//       - "Solution".Base 
//       - "Solution".Base.Data.Enums
//       - "Solution".Base.Data.Model.Interfaces.Systems
//       - "Solution".Base.Data.Model.System
//       - "Solution".Base.Interfaces
//       - "Solution".Base.Mvvm
//       - "Solution".Base.Resource.Themes
...
namespace ${ProjectName}
{
	...
	public class ModuleInit : IModule
	{
		...
		public void Initialize()
		{
			...
			_container.RegisterType<IDataNavigationViewModel, DataNavigationViewModel>();
			...
			_container.RegisterTypeForNavigation<DataNavigationView>();
