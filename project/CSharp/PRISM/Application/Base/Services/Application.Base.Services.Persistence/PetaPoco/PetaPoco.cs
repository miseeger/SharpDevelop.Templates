...
using ${SolutionName}.Base.Services.Persistence.PetaPoco.DatabaseTypes;
...
namespace ${SolutionName}.Base.Services.Persistence.PetaPoco
{
	...
	public class Database : IDatabase
	{
		...
		/// <param name="sql">An SQL builder object representing the query and it's arguments</param>
		/// <returns>The scalar value cast to T</returns>
		public T ExecuteScalar<T>(ISql sql)
		{
		...
		/// <param name="sql">An SQL builder object representing the query and it's arguments</param>
		/// <returns>A List holding the results of the query</returns>
		public List<T> Fetch<T>(ISql sql) 
		{
		...
		/// total number of records in the result set.
		/// </remarks>
		public IPage<T> Page<T>(long page, long itemsPerPage, ISql sql)
		{
		...
		/// The page and itemsPerPage parameters are not used directly and are used simply to populate the returned Page object.
		/// </remarks>
		public IPage<T> Page<T>(long page, long itemsPerPage, ISql sqlCount, ISql sqlPage)
		{
		...
		/// records for the specified page.
		/// </remarks>
		public List<T> Fetch<T>(long page, long itemsPerPage, ISql sql)
		{
		...
		/// records for the specified range.
		/// </remarks>
		public List<T> SkipTake<T>(long skip, long take, ISql sql)
		{
		...
		/// returns the results as a List rather than an IEnumerable.
		/// </remarks>
		public IEnumerable<T> Query<T>(ISql sql)
		{
		...
		/// <param name="sql">An SQL builder object representing the query and it's arguments</param>
		/// <returns>The single record matching the specified primary key value, or default(T) if no matching rows</returns>
		public T SingleOrDefault<T>(ISql sql) 
		{
		...
		/// <param name="sql">An SQL builder object representing the query and it's arguments</param>
		/// <returns>The first record in the result set, or default(T) if no matching rows</returns>
		public T FirstOrDefault<T>(ISql sql) 
		{
		...
		/// <returns>The number of affected rows</returns>
		public int Update<T>(ISql sql)
		{
			var pd = PocoData.ForType(typeof(T));
			return Execute(new Sql(string.Format("UPDATE {0}", _dbType.EscapeTableName(pd.TableInfo.TableName))).Append(sql) as Sql);
		}
		#endregion
		...
		/// <returns>The number of affected rows</returns>
		public int Delete<T>(ISql sql)
		{
			var pd = PocoData.ForType(typeof(T));
			return Execute(new Sql(string.Format("DELETE FROM {0}", _dbType.EscapeTableName(pd.TableInfo.TableName))).Append(sql) as Sql);
		}
		#endregion
		...
		/// <param name="sql">An SQL builder object representing the query and it's arguments</param>
		/// <returns>A collection of POCO's as a List</returns>
		public List<TRet> Fetch<T1, T2, TRet>(Func<T1, T2, TRet> cb, ISql sql) { return Query<T1, T2, TRet>(cb, sql.SQL, sql.Arguments).ToList(); }
		...
		/// <param name="sql">An SQL builder object representing the query and it's arguments</param>
		/// <returns>A collection of POCO's as a List</returns>
		public List<TRet> Fetch<T1, T2, T3, TRet>(Func<T1, T2, T3, TRet> cb, ISql sql) { return Query<T1, T2, T3, TRet>(cb, sql.SQL, sql.Arguments).ToList(); }
		...
		/// <param name="sql">An SQL builder object representing the query and it's arguments</param>
		/// <returns>A collection of POCO's as a List</returns>
		public List<TRet> Fetch<T1, T2, T3, T4, TRet>(Func<T1, T2, T3, T4, TRet> cb, ISql sql) { return Query<T1, T2, T3, T4, TRet>(cb, sql.SQL, sql.Arguments).ToList(); }
		...
		/// <param name="sql">An SQL builder object representing the query and it's arguments</param>
		/// <returns>A collection of POCO's as an IEnumerable</returns>
		public IEnumerable<TRet> Query<T1, T2, TRet>(Func<T1, T2, TRet> cb, ISql sql) { return Query<TRet>(new Type[] { typeof(T1), typeof(T2) }, cb, sql.SQL, sql.Arguments); }
		...
		/// <param name="sql">An SQL builder object representing the query and it's arguments</param>
		/// <returns>A collection of POCO's as an IEnumerable</returns>
		public IEnumerable<TRet> Query<T1, T2, T3, TRet>(Func<T1, T2, T3, TRet> cb, ISql sql) { return Query<TRet>(new Type[] { typeof(T1), typeof(T2), typeof(T3) }, cb, sql.SQL, sql.Arguments); }
		...
		/// <param name="sql">An SQL builder object representing the query and it's arguments</param>
		/// <returns>A collection of POCO's as an IEnumerable</returns>
		public IEnumerable<TRet> Query<T1, T2, T3, T4, TRet>(Func<T1, T2, T3, T4, TRet> cb, ISql sql) { return Query<TRet>(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4) }, cb, sql.SQL, sql.Arguments); }
		...
		/// <param name="sql">An SQL builder object representing the query and it's arguments</param>
		/// <returns>A collection of POCO's as a List</returns>
		public List<T1> Fetch<T1, T2>(ISql sql) { return Query<T1, T2>(sql.SQL, sql.Arguments).ToList(); }
		...
		/// <param name="sql">An SQL builder object representing the query and it's arguments</param>
		/// <returns>A collection of POCO's as a List</returns>
		public List<T1> Fetch<T1, T2, T3>(ISql sql) { return Query<T1, T2, T3>(sql.SQL, sql.Arguments).ToList(); }
		...
		/// <param name="sql">An SQL builder object representing the query and it's arguments</param>
		/// <returns>A collection of POCO's as a List</returns>
		public List<T1> Fetch<T1, T2, T3, T4>(ISql sql) { return Query<T1, T2, T3, T4>(sql.SQL, sql.Arguments).ToList(); }
		...
		/// <param name="sql">An SQL builder object representing the query and it's arguments</param>
		/// <returns>A collection of POCO's as an IEnumerable</returns>
		public IEnumerable<T1> Query<T1, T2>(ISql sql) { return Query<T1>(new Type[] { typeof(T1), typeof(T2) }, null, sql.SQL, sql.Arguments); }
		...
		/// <param name="sql">An SQL builder object representing the query and it's arguments</param>
		/// <returns>A collection of POCO's as an IEnumerable</returns>
		public IEnumerable<T1> Query<T1, T2, T3>(ISql sql) { return Query<T1>(new Type[] { typeof(T1), typeof(T2), typeof(T3) }, null, sql.SQL, sql.Arguments); }
		...
		/// <param name="sql">An SQL builder object representing the query and it's arguments</param>
		/// <returns>A collection of POCO's as an IEnumerable</returns>
		public IEnumerable<T1> Query<T1, T2, T3, T4>(ISql sql) { return Query<T1>(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4) }, null, sql.SQL, sql.Arguments); }
	...
	*/
	...
	/// <summary>
	/// Poco classes marked with the ExplicitColumnsIgnoreBase attribute require all column properties to 
	/// be marked with the Column attribute. Ignoring all Properties of possible base classes from which
	/// the Poco class is derived from.
	/// </summary>
	[AttributeUsage(AttributeTargets.Class)]
	public class ExplicitColumnsIgnoreBaseAttribute : Attribute
	{
	}
	...
	public class ColumnInfo
	{
		...
		{
			// Check if declaring poco has [ExplicitColumns] attribute or
			// [ExplicitColumnsIgnorebase] to ignore all base class properties
			// when deriving the declaring poco from a base class.
			bool ExplicitColumnsIgnoreBase = pi.ReflectedType.GetCustomAttributes(typeof(ExplicitColumnsIgnoreBaseAttribute), true).Length > 0;
			...
			if (ExplicitColumns || ExplicitColumnsIgnoreBase)
			{
	...
	public class Sql : ISql
	{
        ...
        public string SqlRo { get { return _sql; } }
		...
		/// <param name="args">Arguments to any parameters embedded in the SQL</param>
		/// <returns>A reference to this builder, allowing for fluent style concatenation</returns>
		public ISql Append(string sql, params object[] args)
		{
			return Append(new Sql(sql, args));
		}

	    static bool Is(ISql sql, string sqltype)
		{
            return sql != null && sql.SqlRo != null && sql.SqlRo.StartsWith(sqltype, StringComparison.InvariantCultureIgnoreCase);
		}

        bool ISql.Is(ISql sql, string sqltype)
        {
            return Is(sql, sqltype);
        }

		public void Build(StringBuilder sb, List<object> args, ISql lhs)
		{
		...
		/// <returns>A reference to this builder, allowing for fluent style concatenation</returns>
		public ISql Where(string sql, params object[] args)
		{
		...
		/// <returns>A reference to this builder, allowing for fluent style concatenation</returns>
		public ISql OrderBy(params object[] columns)
		{
		...
		/// <returns>A reference to this builder, allowing for fluent style concatenation</returns>
		public ISql Select(params object[] columns)
		{
		...
		/// <returns>A reference to this builder, allowing for fluent style concatenation</returns>
		public ISql From(params object[] tables)
		{
		...
		/// <returns>A reference to this builder, allowing for fluent style concatenation</returns>
		public ISql GroupBy(params object[] columns)
		{
			return Append(new Sql("GROUP BY " + String.Join(", ", (from x in columns select x.ToString()).ToArray())));
		}

		public ISqlJoinClause Join(string JoinType, string table)
		{
		...
		public ISqlJoinClause InnerJoin(string table) { return Join("INNER JOIN ", table); }
		...
		/// <param name="table">The name of the table to join</param>
		/// <returns>A reference an SqlJoinClause through which the join condition can be specified</returns>
		public ISqlJoinClause LeftJoin(string table) { return Join("LEFT JOIN ", table); }

		/// <summary>
		/// The SqlJoinClause is a simple helper class used in the construction of SQL JOIN statements with the SQL builder
		/// </summary>
		public class SqlJoinClause : ISqlJoinClause
		{
			private readonly ISql _sql;

			public SqlJoinClause(ISql sql)
			{
				_sql = sql;
			}
			...
			public ISql On(string onClause, params object[] args)
			{
